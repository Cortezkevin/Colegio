...
public class UsuarioService {
	...
	public void registrarUsuario(Usuario u) {
		repository.RegistrarUsuario(u.getNombreusuario(), u.getContrasena(), u.getIdcargo(), u.getIdpersona(),
				u.getFoto());
	}
	...
	public void actualizarUsuario(Usuario u) {
		repository.ActualizarUsuario(u.getIdusuario(), u.getNombreusuario(), u.getContrasena(), u.getEstado(),
				u.getIdcargo(), u.getIdpersona(), u.getFoto());
	}
