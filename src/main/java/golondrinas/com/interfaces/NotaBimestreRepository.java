...
public interface NotaBimestreRepository extends JpaRepository<NotaBimestre, String>{
	...
	void RegistrarNotaBimestral(@Param("idalumno") String idalumno,@Param("idcurso") String idcurso, @Param("nota_bimestre1") Double nota_bimestre1,@Param("nota_bimestre2") Double nota_bimestre2,
	@Param("nota_bimestre3") Double nota_bimestre3, @Param("nota_bimestre4") Double nota_bimestre4, @Param("promedio_anual") Double promedio_anual);
	...
	void ActualizarNotaBimestral(@Param("idnotabimestre") String idnotabimestre,@Param("idalumno") String idalumno,@Param("idcurso") String idcurso, @Param("nota_bimestre1") Double nota_bimestre1,@Param("nota_bimestre2") Double nota_bimestre2,
			@Param("nota_bimestre3") Double nota_bimestre3, @Param("nota_bimestre4") Double nota_bimestre4, @Param("promedio_anual") Double promedio_anual);
